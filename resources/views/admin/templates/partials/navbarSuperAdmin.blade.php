        ...
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                <li class="special_link">
                    <a href="{{ route('superadmin.dashboard') }}"><i class="fa fa-th-large"></i> <span class="nav-label">Dashboards</span></a>
                </li>
                <li class="{{ Request::is('*/daftar_belanja*') ? 'active' : '' }}">
                    <a href=""><i class="fa fa-bar-chart"></i> <span class="nav-label">Daftar Belanja</span></a>
                </li>
