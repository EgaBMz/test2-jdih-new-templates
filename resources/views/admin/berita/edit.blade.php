                        ...
                        <div class="ibox-content">
                            <form action="{{ route('admin.berita.update', $berita) }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="judul" name="judul" placeholder="Judul Berita" class="form-control" value="{{ $berita->judul }}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <img src="{{ asset($berita->file) }}" alt="foto atlet" height="250px">
                                </div>
                                <div class="form-group">
                                    <textarea class="form-control" name="deskripsi" id="summernote">{{ $berita->deskripsi }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label>Publish</label> 
                                    <select class="form-control m-b" name="publik" id="publik">
                                        <option value="t" @if($berita->publik == 1) selected @endif>Ya</option>
                                        <option value="f" @if($berita->publik == 0) selected @endif>Tidak</option>
                                    </select>
                                </div>
                                <div class="form-group">
