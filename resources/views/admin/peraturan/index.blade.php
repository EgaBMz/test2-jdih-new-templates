                    ...
                    <div class="ibox ">
                        ...
                        <div class="input-group mb-3">
                                ...
                                <div class="input-group-append">
                                    <a href="{{ route('admin.peraturan.create') }}" class="btn btn-sm btn-info" type="button"><i class="fa fa-plus"></i> Tambah Peraturan</a>
                                </div>
                            </div>
                        ...
                        <thead>
                            <tr>
                                ...
                                <td align="left" width="90%"><b>Jenis Peraturan<b></td>
                        ...
                        <tbody>
                            ...
                            <tr class="gradeX">
                                ...
                                <td align="center">
                                    <a href="{{ route('admin.peraturan.edit', $data->id) }}" type="button" class="btn btn-primary btn-xs">Ubah</a>
                                </td>
                            </tr>
                            @endforeach
                        </tfoot>
