                ...
                <div class="col-lg-12">
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                            <form action="{{ route('admin.portofolio.update', $portofolio) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="form-group">
                                    <label>Judul Portofolio</label> 
                                    <input type="text" id="judul" name="judul" placeholder="Judul Portofolio" class="form-control" value="{{ $portofolio->judul }}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <img src="{{ asset($portofolio->file) }}" alt="foto atlet" height="250px">
                                </div>
                                <div class="form-group">
                                    <textarea class="form-control" name="deskripsi" id="summernote">{{ $portofolio->deskripsi }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label>Publish</label> 
                                    <select class="form-control m-b" name="publik" id="publik">
                                        <option value="1" @if($portofolio->publik == 1) selected @endif>Ya</option>
                                        <option value="0" @if($portofolio->publik == 0) selected @endif>Tidak</option>
                                    </select>
                                </div>
                                <div class="form-group">
