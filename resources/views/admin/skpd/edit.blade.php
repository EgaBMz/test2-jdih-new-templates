                        ...
                        <div class="ibox-content">
                            <form action="{{ route('admin.skpd.update', $skpd) }}" method="POST">
                                ...
                                <div class="form-group">
                                    <label>SKPD Pemrakarsa</label> 
                                    <input type="text" id="skpd_pemrakarsa" name="skpd_pemrakarsa" placeholder="SKPD Pemrakarsa" class="form-control" value="{{ $skpd->skpd_pemrakarsa }}">
                                    @error('skpd')
